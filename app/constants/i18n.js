export const I18N = {
  ru: {
    ...
    metaTitle: "VASORION — system over noise",
    metaDescription: "VasOrion: экосистема мышления, решений и цифровой идентичности.",
    ...
    linksChannel: "Канал",
    linksEmail: "Email",
    linksUpdatesPrefix: "Обновления: свежие новости и обновления в",
    linksUpdatesLink: "официальном Telegram-канале",
    contact: "Контакты",
  ...
  en: {
    navTag: "system over noise",
    metaTitle: "VASORION — system over noise",
    metaDescription: "VasOrion: an ecosystem of thinking, decisions, and digital identity.",
    ...
    linksEmail: "Email",
    linksUpdatesPrefix: "Updates: news and updates in",
    linksUpdatesLink: "official Telegram channel",
    contact: "Contact",
    channelName: "VasOrion Official",
  ...
  zh: {
    navTag: "system over noise",
    metaTitle: "VASORION — system over noise",
    metaDescription: "VasOrion：思考、决策与数字身份的生态系统。",
    skipToContent: "跳至內容",
    heroTitle: "VASORION",
    heroSubtitle:
    ...
    linksChannel: "頻道",
    linksEmail: "Email",
    linksUpdatesPrefix: "更新：最新消息與更新在",
    linksUpdatesLink: "官方 Telegram 頻道",
    contact: "聯絡",
    channelName: "VasOrion Official",
